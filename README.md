...
[![Paper](https://img.shields.io/badge/paper-EMNLP%202026%20Findings-b31b1b)](paper/echolens_emnlp2026_findings.pdf)
...
([PDF](paper/echolens_emnlp2026_findings.pdf) — temporary copy while Findings publishes;
...
└── paper/        # the paper, plus rendered figures and tables
```
...
```
paper/
├── echolens_emnlp2026_findings.pdf
